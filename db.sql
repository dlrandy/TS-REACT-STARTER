CREATE SEQUENCE tbl_lookup_seq;

CREATE TABLE tbl_lookup
(
	id INTEGER NOT NULL PRIMARY KEY DEFAULT NEXTVAL ('tbl_lookup_seq'),
...
(
	id INTEGER NOT NULL PRIMARY KEY DEFAULT NEXTVAL ('tbl_role_seq'),
	name VARCHAR(128) NOT NULL,
...
(
	id INTEGER NOT NULL PRIMARY KEY DEFAULT NEXTVAL ('tbl_user_seq'),
	...
	REFERENCES tbl_role (id) ON DELETE CASCADE ON UPDATE RESTRICT
)  ;
...
(
	id INTEGER NOT NULL PRIMARY KEY DEFAULT NEXTVAL ('tbl_post_seq'),
...
(
	id INTEGER NOT NULL PRIMARY KEY DEFAULT NEXTVAL ('tbl_comment_seq'),
	content TEXT NOT NULL,
	status INTEGER NOT NULL,
	create_time INTEGER,
...
CREATE SEQUENCE tbl_tag_seq;

CREATE TABLE tbl_tag
(
	id INTEGER NOT NULL PRIMARY KEY DEFAULT NEXTVAL ('tbl_tag_seq'),
	name VARCHAR(128) NOT NULL,
